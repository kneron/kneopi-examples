...
void LCD_1IN47_test(void)
{
    ...
    Paint_DrawString_CN(1,125, "微雪电子Abc",  &Font24CN, WHITE, BLUE);
    ...
    // /* change backlight */
    printf("changing backlight...\r\n");
    LCD_1IN47_SetBacklight(50);
    DEV_Delay_ms(1000);
    LCD_1IN47_SetBacklight(100);
    DEV_Delay_ms(1000);
    LCD_1IN47_SetBacklight(50);
    DEV_Delay_ms(1000);
    LCD_1IN47_SetBacklight(80);
    DEV_Delay_ms(1000);
